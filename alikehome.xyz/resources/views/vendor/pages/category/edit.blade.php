        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{ route('vendor.pages.category.update',$category->id) }}" enctype="multipart/form-data">
                          <!-- {{ csrf_field() }} -->
                          @csrf
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <img src="{{asset('img/categories/'.$category->image)}}" alt="product" width="100"> <br>
