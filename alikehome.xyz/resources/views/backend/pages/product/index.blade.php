...
{{--          <a href="{{ route('backend.pages.product.liquid',$products->id) }}" class="btn btn-success btn-sm">Size </a>--}}
{{--          <a href="{{ route('backend.pages.product.color',$products->id) }}" class="btn btn-primary btn-sm">Color </a>--}}
{{--          <a href="{{ route('backend.pages.product.edit_jfu',$products->id) }}" class="btn btn-dark btn-sm"> Just_for_you </a>--}}
{{--        </div>--}}
{{--       </td>--}}
