    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            <tr class="top">
                <td colspan="2">
                    <table>
                        <tr>
                            <td class="title">
                                <h3 style="color: black;">Flair BD</h3>
                            </td>
            ...
            @php
                             $total_price = 0;
                             @endphp
                              @foreach(App\Cart::Where('ip_address',$order->ip_address)->where('order_id',$order->id)->get() as $partents)
            <tr class="item">
            ...
            <tr class="total">
                ...
                <td>
                   Total: {{$total_price + $order->payment_id}}
                </td>
            </tr>
