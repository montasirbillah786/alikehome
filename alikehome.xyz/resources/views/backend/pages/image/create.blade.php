...
@include('layouts.message')
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="note"  placeholder="Enter Size(Dimension)">
    </div>
    <div class="form-group">
      <label>Placement</label>
      <input type="text" class="form-control" name="sell_description"  placeholder="Enter Placement">
    </div>
    <div class="form-group">
      <label>Size(Dimension)</label>
      <input type="text" class="form-control" name="sell_note"  placeholder="Enter Size(Dimension)">
    </div>
    <div class="form-group">
      <label>Placement</label>
      <input type="text" class="form-control" name="link"  placeholder="Enter Placement">
    </div>
