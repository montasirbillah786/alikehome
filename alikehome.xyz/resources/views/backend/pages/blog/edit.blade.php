            ...
            <div class="card card-primary">
              ...
              <form method="post" action="{{ route('admin.blog.update',$blog->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Name</label>
                    <input type="text" class="form-control" name="tag"  placeholder="Enter Blog name" value="{{$blog->tag}}">
                  </div>
                  <div class="form-group">
                    <label>Description 1</label>
                     <textarea class="textarea" name="description1" placeholder="Place some text here"
                          style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 20px;">{!! $blog->description1 !!}</textarea>
                  </div>
                   <div class="form-group">
                    <label>Description 2</label>
                     <textarea class="textarea" name="description2" placeholder="Place some text here"
                          style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 20px;">{!! $blog->description2 !!}</textarea>
                  </div>
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <img src="{{getImage($blog->image,'blog')}}" alt="product" width="100"> <br>
blog  Image</label>
